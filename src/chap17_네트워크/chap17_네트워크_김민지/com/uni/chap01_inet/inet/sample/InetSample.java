package chap17_네트워크.chap17_네트워크_김민지.com.uni.chap01_inet.inet.sample;
...
public class InetSample {
	...
	// 1. 네트워크(Network)란?
		...
		public void isSmple() {
			try {
				InetAddress localIp = InetAddress.getLocalHost(); // 내컴퓨터의 IP주소 반환
				System.out.println("내 PC명 : " + localIp.getHostName() ); // 호스트의 이름반환
				System.out.println("내 IP주소 : " + localIp.getHostAddress() ); // 호스트의 IP주소
				
				InetAddress naverIp = InetAddress.getByName("www.naver.com"); // 도메인명을 통해 ip주소를 얻는다.
				
				System.out.println("네이버 서버명 : " + naverIp.getHostName());
				System.out.println("네이버서버주소 : " + naverIp.getHostAddress());
