package chap17_네트워크.김민보.chap01_inet.sample;
...
public class InetSample {
	...
	public void isSample() {
		try {
			InetAddress localIp = InetAddress.getLocalHost();//내컴퓨터의 아이피주소
			
			System.out.println("내 피씨명 : " + localIp.getHostName());//호스트의 이름
			System.out.println("내 아이피 : " + localIp.getHostAddress());//호스트의주소
			
			InetAddress naverIp = InetAddress.getByName("www.naver.com");
			
			System.out.println("내 피씨명 : " + naverIp.getHostName());//호스트의 이름
			System.out.println("내 아이피 : " + naverIp.getHostAddress());//호스트의주소
